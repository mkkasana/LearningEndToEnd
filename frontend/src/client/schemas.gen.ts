...
export const AttachmentRequestCreateSchema = {
    properties: {
        target_person_id: {
            type: 'string',
            format: 'uuid',
    ...
    title: 'AttachmentRequestCreate',
    description: 'Schema for creating an attachment request.'
} as const;

export const AttachmentRequestPublicSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
        ...
        status: {
            '$ref': '#/components/schemas/AttachmentRequestStatus'
        },
        created_at: {
            type: 'string',
            format: 'date-time',
    ...
    type: 'object',
    required: ['id', 'requester_user_id', 'requester_person_id', 'target_person_id', 'approver_user_id', 'status', 'created_at', 'resolved_at', 'resolved_by_user_id'],
    title: 'AttachmentRequestPublic',
    description: 'Schema for public attachment request response.'
} as const;

export const AttachmentRequestStatusSchema = {
    type: 'string',
    enum: ['pending', 'approved', 'denied', 'cancelled'],
    title: 'AttachmentRequestStatus',
    description: 'Status options for person attachment requests.'
} as const;

export const AttachmentRequestWithDetailsSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
        ...
        requester_middle_name: {
            ...
            title: 'Requester Middle Name',
            description: "Requester's middle name"
        },
        requester_last_name: {
            type: 'string',
        ...
        requester_date_of_birth: {
            type: 'string',
            format: 'date',
            title: 'Requester Date Of Birth',
            description: "Requester's date of birth"
        },
        requester_gender: {
            type: 'string',
            title: 'Requester Gender',
            description: "Requester's gender display name"
        },
        requester_address_display: {
            anyOf: [
                {
                    type: 'string'
                },
            ...
            title: 'Requester Address Display',
            description: "Requester's formatted address"
        },
        requester_religion_display: {
            anyOf: [
                {
                    type: 'string'
                },
            ...
            title: 'Requester Religion Display',
            description: "Requester's formatted religion"
        },
        target_first_name: {
            type: 'string',
            title: 'Target First Name',
        ...
        target_middle_name: {
            ...
            title: 'Target Middle Name',
            description: "Target person's middle name"
        },
        target_last_name: {
            type: 'string',
            title: 'Target Last Name',
        ...
        target_date_of_birth: {
            ...
            description: "Target person's date of birth"
        }
    },
    type: 'object',
    required: ['id', 'status', 'created_at', 'requester_first_name', 'requester_last_name', 'requester_date_of_birth', 'requester_gender', 'target_first_name', 'target_last_name', 'target_date_of_birth'],
    title: 'AttachmentRequestWithDetails',
    description: `Schema for attachment request with requester and target details.
...
export const MyPendingRequestResponseSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
        ...
        target_gender: {
            type: 'string',
            title: 'Target Gender',
            description: "Target person's gender display name"
        }
    },
    type: 'object',
    required: ['id', 'status', 'created_at', 'target_first_name', 'target_last_name', 'target_date_of_birth', 'target_gender'],
    title: 'MyPendingRequestResponse',
    description: "Schema for requester's pending request view."
} as const;
...
export const PendingCountResponseSchema = {
    properties: {
        count: {
            type: 'integer',
            title: 'Count',
            description: 'Number of pending requests for the user to approve'
        }
    },
    type: 'object',
    required: ['count'],
    title: 'PendingCountResponse',
    description: 'Schema for pending request count response.'
} as const;
...
export const PersonSearchResultSchema = {
    properties: {
        ...
        gender_id: {
            ...
            title: 'Gender Id',
            description: 'Gender ID for avatar styling (optional)'
        },
        name_match_score: {
            anyOf: [
                {
