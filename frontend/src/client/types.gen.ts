 ...
 */
export type AttachmentRequestCreate = {
    /**
     * The existing person record to attach to
     */
 ...
 */
export type AttachmentRequestPublic = {
    id: string;
 ...
 */
export type AttachmentRequestStatus = 'pending' | 'approved' | 'denied' | 'cancelled';
 ...
 */
export type AttachmentRequestWithDetails = {
    id: string;
    status: AttachmentRequestStatus;
    created_at: string;
    /**
    ...
    /**
     * Requester's gender display name
     */
    requester_gender: string;
    /**
     * Requester's formatted address
     */
    requester_address_display?: (string | null);
    /**
     * Requester's formatted religion
     */
    requester_religion_display?: (string | null);
    /**
     * Target person's first name
     */
    target_first_name: string;
    /**
     * Target person's middle name
     */
 ...
 */
export type MyPendingRequestResponse = {
    id: string;
    status: AttachmentRequestStatus;
    created_at: string;
    /**
    ...
    target_date_of_birth: string;
    /**
     * Target person's gender display name
     */
...
export type PendingCountResponse = {
    /**
     * Number of pending requests for the user to approve
     */
    count: number;
};
...
export type PersonSearchResult = {
    ...
    date_of_birth: string;
    /**
     * Gender ID for avatar styling (optional)
     */
    gender_id?: (string | null);
    /**
...
export type AttachmentRequestsCreateAttachmentRequestData = {
    requestBody: AttachmentRequestCreate;
};

export type AttachmentRequestsCreateAttachmentRequestResponse = (AttachmentRequestPublic);

export type AttachmentRequestsGetRequestsToApproveResponse = (Array<AttachmentRequestWithDetails>);

export type AttachmentRequestsGetMyPendingRequestResponse = (MyPendingRequestResponse);

export type AttachmentRequestsGetPendingCountResponse = (PendingCountResponse);

export type AttachmentRequestsApproveAttachmentRequestData = {
    requestId: string;
};

export type AttachmentRequestsApproveAttachmentRequestResponse = (Message);

export type AttachmentRequestsDenyAttachmentRequestData = {
    requestId: string;
};

export type AttachmentRequestsDenyAttachmentRequestResponse = (Message);

export type AttachmentRequestsCancelAttachmentRequestData = {
    requestId: string;
};

export type AttachmentRequestsCancelAttachmentRequestResponse = (Message);
