    ...
    <div className="p-8 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="space-y-4">
          <h3 className="text-lg font-semibold">Selected Person (Full Opacity)</h3>
          <PersonCard
            person={mockPerson}
            variant="selected"
            onClick={() => {}}
        ...
        <div className="space-y-4">
          ...
          />
          <p className="text-sm text-muted-foreground">opacity-75 applied (existing)</p>
        </div>
      </div>
      ...
      <div className="mt-8 p-4 bg-muted rounded-lg">
        ...
        <ul className="list-disc list-inside space-y-1 text-sm">
          ...
          <li>Spouse: Reduced opacity (75%) - de-emphasized to show they're not blood relatives</li>
          <li>Sibling: Reduced opacity (75%) - de-emphasized but still visible</li>
