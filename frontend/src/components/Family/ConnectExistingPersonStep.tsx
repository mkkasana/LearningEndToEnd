      ...
      {isError && !isLoading && !isFetching && (
        <div className="space-y-4 py-4">
          <div className="bg-destructive/10 border border-destructive/20 rounded-md p-4">
            ...
            <p className="text-sm text-muted-foreground">
              {error?.message ||
                "An error occurred while searching. Please try again or proceed to create a new person."}
            </p>
          </div>
        ...
        matchingPersons.length === 0 && (
          <div className="space-y-4 py-4">
            <div className="bg-muted p-4 rounded-md">
              ...
              <p className="text-sm text-muted-foreground">
                We could not find any existing person with similar details. This
                does not appear to be a duplicate. You can proceed to create
                this new person.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-muted p-3 rounded-md text-sm">
              <p className="text-muted-foreground">
                We found some existing persons that match the details you
                entered. You can connect to an existing person or create a new
                one.
              </p>
            </div>
