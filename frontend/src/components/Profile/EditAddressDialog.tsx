...
interface EditAddressDialogProps {
  ...
  currentAddress: PersonAddressPublic | null
  onSuccess?: () => void
}
...
export function EditAddressDialog({
  ...
  // Initialize form with current address when dialog opens
  useEffect(() => {
  ...
  const updateAddressMutation = useMutation({
    mutationFn: (data: PersonAddressUpdate) =>
      PersonService.updateMyAddress({
    ...
    onError: (error: any) => {
      showErrorToast(error.message || "Failed to update address")
    },
  })

  const onSubmit = (data: FormData) => {
    const addressData: PersonAddressUpdate = {
