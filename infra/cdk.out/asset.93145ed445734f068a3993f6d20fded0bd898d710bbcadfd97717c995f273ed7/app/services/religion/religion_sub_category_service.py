...
class ReligionSubCategoryService:
    ...
    def get_sub_categories_by_category(
        ...
        logger.debug(
            f"Found {len(sub_categories)} sub-categories for category {category_id}"
        )
        return [
    ...
    def get_sub_category_by_id(
        ...
        if sub_category:
            logger.debug(
                f"Religion sub-category found: {sub_category.name} (ID: {sub_category_id})"
            )
        else:
    ...
    def create_sub_category(
        ...
        logger.info(
            f"Creating religion sub-category: {sub_category_create.name} for category {sub_category_create.category_id}"
        )
        ...
        logger.info(
            f"Religion sub-category created successfully: {created_sub_category.name} (ID: {created_sub_category.id})"
        )
    ...
    def update_sub_category(
        ...
        logger.info(
            f"Updating religion sub-category: {sub_category.name} (ID: {sub_category.id})"
        )
        ...
        if update_fields:
            logger.debug(
                f"Updating fields for religion sub-category {sub_category.id}: {update_fields}"
            )
        ...
        logger.info(
            f"Religion sub-category updated successfully: {updated_sub_category.name} (ID: {updated_sub_category.id})"
        )
    ...
    def delete_sub_category(self, sub_category: ReligionSubCategory) -> None:
        ...
        logger.warning(
            f"Deleting religion sub-category: {sub_category.name} (ID: {sub_category.id})"
        )
        self.sub_category_repo.delete(sub_category)
        logger.info(
            f"Religion sub-category deleted successfully: {sub_category.name} (ID: {sub_category.id})"
        )
    ...
    def code_exists(
        ...
        logger.debug(
            f"Checking if religion sub-category code exists: {code} in category {category_id}"
        )
