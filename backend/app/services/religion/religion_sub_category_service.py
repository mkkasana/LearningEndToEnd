...
class ReligionSubCategoryService:
    ...
    def get_sub_categories_by_category(
        ...
        sub_categories = self.sub_category_repo.get_sub_categories_by_category(category_id)
        return [
            ReligionSubCategoryPublic(subCategoryId=sc.id, subCategoryName=sc.name)
            for sc in sub_categories
        ]

    def get_sub_category_by_id(self, sub_category_id: uuid.UUID) -> ReligionSubCategory | None:
    ...
    def update_sub_category(
        self, sub_category: ReligionSubCategory, sub_category_update: ReligionSubCategoryUpdate
    ) -> ReligionSubCategory:
    ...
    def code_exists(
        ...
        return self.sub_category_repo.code_exists(code, category_id, exclude_sub_category_id)
