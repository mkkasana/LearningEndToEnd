...
class ReligionService:
    ...
    def create_religion(self, religion_create: ReligionCreate) -> Religion:
        ...
        logger.info(
            f"Creating religion: {religion_create.name} (code: {religion_create.code})"
        )
        ...
        logger.info(
            f"Religion created successfully: {created_religion.name} (ID: {created_religion.id})"
        )
    ...
    def update_religion(
        ...
        logger.info(
            f"Religion updated successfully: {updated_religion.name} (ID: {updated_religion.id})"
        )
    ...
    def delete_religion(self, religion: Religion) -> None:
        ...
        logger.info(
            f"Religion deleted successfully: {religion.name} (ID: {religion.id})"
        )
