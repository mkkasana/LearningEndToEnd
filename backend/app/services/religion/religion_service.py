...
class ReligionService:
    ...
    def get_religions(self) -> list[ReligionPublic]:
        ...
        return [
            ReligionPublic(religionId=r.id, religionName=r.name) for r in religions
        ]
    ...
    def update_religion(self, religion: Religion, religion_update: ReligionUpdate) -> Religion:
        """Update a religion."""
