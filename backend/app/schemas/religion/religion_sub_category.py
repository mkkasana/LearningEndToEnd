...
class ReligionSubCategoryBase(SQLModel):
    ...
    name: str = Field(max_length=255, description="Sub-category name (e.g., Sub-caste, Sub-sect)")
...
class ReligionSubCategoryCreate(ReligionSubCategoryBase):
    ...
    category_id: uuid.UUID = Field(description="Category ID this sub-category belongs to")
