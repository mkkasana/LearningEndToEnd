...
- [ ] 1. Set up project structure and configuration
  - [ ] 1.1 Add LINEAGE_PATH_MAX_DEPTH configuration to settings
    - Add new field to `app/core/config.py` Settings class
    - Default value: 10
    - Environment variable: `LINEAGE_PATH_MAX_DEPTH`
    - _Requirements: 1.5_

  - [ ] 1.2 Create directory structure for lineage_path module
...
- [ ] 2. Implement schema definitions
  - [ ] 2.1 Create lineage path schemas
...
- [ ] 3. Implement service layer
  ...
  - [ ] 3.4 Implement person data enrichment
  ...
  - [ ] 3.5 Implement graph building method
  ...
  - [ ] 3.6 Implement main find_path method
  ...
  - [ ] 3.9 Write unit tests for person data enrichment
  ...
  - [ ] 3.10 Write unit tests for graph building
  ...
  - [ ] 3.11 Write unit tests for main find_path method
