...
- [ ] 1. Add new types to FindPartner types.ts
  - [ ] 1.1 Add TypeScript interfaces for match visualization
...
- [ ] 2. Implement path extraction utility
  - [ ] 2.1 Create `frontend/src/components/FindPartner/utils/matchPathExtractor.ts`
  ...
  - [ ]* 2.2 Write property tests for path extraction
    - **Property 1: Path Extraction Correctness**
    - **Property 2: Match Sorting by Depth**
    - **Validates: Requirements 3.1, 3.2, 1.4**

- [ ] 3. Implement graph transformation utility
  - [ ] 3.1 Create `frontend/src/components/FindPartner/utils/matchGraphTransformer.ts`
  ...
  - [ ]* 3.2 Write property tests for graph transformation
...
- [ ] 5. Implement MatchSelector component
  - [ ] 5.1 Create `frontend/src/components/FindPartner/MatchSelector.tsx`
...
- [ ] 6. Implement MatchPathSummary component
  - [ ] 6.1 Create `frontend/src/components/FindPartner/MatchPathSummary.tsx`
    - Display path as "Name1 → Name2 → Name3..."
    - Accept array of names as prop
    - _Requirements: 4.1, 4.2, 4.3_
  - [ ]* 6.2 Write property test for path summary
    - **Property 3: Path Summary Correctness**
    - **Validates: Requirements 4.1, 4.2, 4.3**

- [ ] 7. Implement MatchPersonNode component
  - [ ] 7.1 Create `frontend/src/components/FindPartner/MatchPersonNode.tsx`
  ...
  - [ ]* 7.2 Write property tests for node display
    - **Property 5: Node Label Correctness**
    - **Property 6: Birth-Death Year Formatting**
    - **Validates: Requirements 6.3, 6.4, 6.5**

- [ ] 8. Implement MatchRelationshipEdge component
  - [ ] 8.1 Create `frontend/src/components/FindPartner/MatchRelationshipEdge.tsx`
  ...
  - [ ]* 8.2 Write property test for edge styling
    - **Property 7: Edge Styling Correctness**
    - **Validates: Requirements 7.1, 7.2, 7.3, 7.5**

- [ ] 9. Implement MatchGraphControls component
  - [ ] 9.1 Create `frontend/src/components/FindPartner/MatchGraphControls.tsx`
    - Add zoom in button
    - Add zoom out button
    - Add fit view button
...
- [ ] 10. Checkpoint - UI components complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 11. Implement MatchGraph component
  - [ ] 11.1 Create `frontend/src/components/FindPartner/MatchGraph.tsx`
...
- [ ] 12. Update PartnerResultsDisplay component
  - [ ] 12.1 Replace JSON display with graph visualization
  ...
  - [ ] 12.2 Handle empty/no matches state
    - Show "No matches found" message when total_matches = 0
    - Hide MatchSelector and MatchGraph when no matches
    - _Requirements: 2.1, 2.2, 2.3_

- [ ] 13. Update barrel exports
  - [ ] 13.1 Update `frontend/src/components/FindPartner/index.ts`
